...
/**
 * String Utility Class This is used to operate string programmatically
 * 
 * <p>
...
public class StringUtil {
	...
	/**
	 * return the correct string in parameterized charset//TODO
	 * 
	 * @param str
	 *            String
	 * @param charset
	 ...
	 * @return String
	 */
	static public String convert2Charset(String str) {
		if (null != str) {
			try {
				byte[] b = str.getBytes("ISO8859_1");
				String strnew = new String(b);
				return strnew;
	...
	public static void main(String[] args) {
		String str = StringUtil.encodeString("123456");
		System.out.println(str);
		String str2 = StringUtil.decodeString(str);
